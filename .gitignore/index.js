...
client.on('message', message =>{
 ...
 if (message.channel.id !== '518190701050069012') return;
    ...
    message.author.send("Voici le contenue de la huitième case de votre calendrier : Mon huitième est ``N``. Vous remportez également un snack de votre choix !")
 ...
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    if (today.getDate() === 8 && today.getMonth() === 11) {
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°8 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la huitième case de votre calendrier : Mon huitième est ``N``. Vous remportez également un snack de votre choix !")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°8 !`)
