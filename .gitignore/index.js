...
client.on('message', message =>{
 ...
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    if (today.getDate() === 23 && today.getMonth() === 11) {
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°23 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la vingt-troisième case de votre calendrier : Mon vingt-troisième est ``d``. Tu remportes également 6 DcCoins !")
