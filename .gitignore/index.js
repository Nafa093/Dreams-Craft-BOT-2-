...
client.on('message', message =>{
 ...
 if (message.channel.id !== '518190701050069012') return;
    if (today.getDate() === 5 && today.getMonth() === 11) {
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°5 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la cinquième case de votre calendrier : Mon cinquième est (encore) ``l``. Vous remportez également un Kinder.")
 ...
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    if (today.getDate() === 22 && today.getMonth() === 11) {
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°22 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la vingt-deuxième case de votre calendrier : Mon vingt-deuxième est ``r``. J'aimerai également me corriger haha ! Hier j'ai dis seizième à la place de vingt et unième !")
 ...
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    if (today.getDate() === 20 && today.getMonth() === 11) {
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°20 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la vingtième case de votre calendrier : Mon dixneuvième est ``c``. Vous reportez également 5 DcCoins !!")
