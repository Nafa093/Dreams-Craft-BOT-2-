...
client.on('message', message =>{
 ...
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    if (today.getDate() === 19 && today.getMonth() === 11) {
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°19 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la dixneuvième case de votre calendrier : Mon dixneuvième est ``s``. Vous ne remporter rien d'autres !")
