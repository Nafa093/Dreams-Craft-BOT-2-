...
console.log(today.getUTC-1Hours() + "UTC");
...
client.on('message', message =>{
 ...
 if (message.channel.id !== '518190701050069012') return;
    ...
    if (today.getDate() === 3 && today.getMonth() === 11) {
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°3 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la troisième case de votre calendrier : Mon troisième est ``a``. Vous ne remportez pas de DcCoins aujourd'hui ! :(")
 ...
 if (message.channel.id !== '518190701050069012') return;
    ...
    message.author.send("Voici le contenue de la deuxième case de votre calendrier : Mon deuxième est ``b``. Vous remportez également 1 DcCoins !")
