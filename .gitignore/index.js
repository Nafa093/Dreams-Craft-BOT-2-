...
client.on('message', message =>{
 ...
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    if (today.getDate() === 14 && today.getMonth() === 11) {
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°14 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la quatorzième case de votre calendrier : Mon quatorzième est `` ``(un espace). Vous remportez également 4 DcCoins !")
