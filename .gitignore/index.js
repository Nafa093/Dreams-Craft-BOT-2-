...
client.on('message', message =>{
 ...
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    if (today.getDate() === 21 && today.getMonth() === 11) {
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°21 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la vingt et unième case de votre calendrier : Mon sezième est ``o``. Vous remportez rien d'autres.")
