...
client.on('message', message =>{
 ...
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    if (today.getDate() === 16 && today.getMonth() === 11) {
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°16 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la sezième case de votre calendrier : Mon sezième est `` ``(un espace). Vous remportez rien d'autres.")
 ...
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    if (today.getDate() === 15 && today.getMonth() === 11) {
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°15 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la quinzième case de votre calendrier : Mon quinzième est ``=``. Vous remportez également une rencontre privilégié avec un personnage lors de la soft !")
