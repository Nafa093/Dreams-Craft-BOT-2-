...
client.on('message', message =>{
 ...
 if (message.channel.id !== '518190701050069012') return;
    ...
    message.author.send("Voici le contenue de la cinquième case de votre calendrier : Mon tout est une commande. Je te laisse également le privilège d'ouvrir toutes les anciennes cases aujourd'hui et seulement aujourd'hui !")
