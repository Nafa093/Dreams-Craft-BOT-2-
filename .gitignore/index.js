...
client.on('message', message =>{
 ...
 if (message.channel.id !== '518190701050069012') return;
    ...
    message.author.send("Voici le contenue de la première case de votre calendrier : Mon premier est ``8``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°1 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 2`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°2 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la deuxième case de votre calendrier : Mon deuxième est ``b``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°2 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 3`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°3 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la troisième case de votre calendrier : Mon troisième est ``a``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°3 !`)
  } 
 ...
 if (message.channel.id !== '518190701050069012') return;
    ...
    message.author.send("Voici le contenue de la quatrième case de votre calendrier : Mon quatrième est ``l``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°4 !`)
  } 

   if (message.content.toLocaleLowerCase() === `/case 5`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°5 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la cinquième case de votre calendrier : Mon cinquième est ``l``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°5 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 6`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°6 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la sixième case de votre calendrier : Mon sixième est `` `` (un espace).")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°6 !`)
  } 
 ...
 if (message.channel.id !== '518190701050069012') return;
    ...
    message.author.send("Voici le contenue de la septième case de votre calendrier : Mon septième est ``q``")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°7 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 8`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°8 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la huitième case de votre calendrier : Mon huitième est ``N``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°8 !`)
  } 
 ...
 if (message.channel.id !== '518190701050069012') return;
    ...
    message.author.send("Voici le contenue de la neuvième case de votre calendrier : Mon neuvième est ``G``")
 ...
 if (message.channel.id !== '518190701050069012') return;
    ...
    message.author.send("Voici le contenue de la dixième case de votre calendrier : Mon dixième est ``3``.")
 ...
 if (message.channel.id !== '518190701050069012') return;
    ...
    message.author.send("Voici le contenue de la onzième case de votre calendrier : Mon onzième est ``D``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°11 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 12`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°12 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la douzième case de votre calendrier : Mon douzième est ``q``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°12 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 13`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°13 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la treizième case de votre calendrier : Mon treizième est ``g``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°13 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 14`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°14 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la quatorzième case de votre calendrier : Mon quatorzième est `` ``(un espace).")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°14 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 15`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°15 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la quinzième case de votre calendrier : Mon quinzième est ``=``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°15 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 16`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°16 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la sezième case de votre calendrier : Mon sezième est`` ``(un espace).")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°16 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 17`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°17 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la dixseptième case de votre calendrier : Mon dixseptième est ``d``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°17 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 18`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°18 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la dixshuitième case de votre calendrier : Mon dixshuitième est ``i``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°18 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 19`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°19 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la dixneuvième case de votre calendrier : Mon dixneuvième est ``s``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°19 !`)
  } 
  
  
   if (message.content.toLocaleLowerCase() === `/case 20`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°20 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la vingtième case de votre calendrier : Mon vingtième est ``c``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°20 !`)
  } 
  
  
   if (message.content.toLocaleLowerCase() === `/case 21`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°21 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la vingt et unième case de votre calendrier : Mon vingt et unième est ``o``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°21 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 22`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°22 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la vingt-deuxième case de votre calendrier : Mon vingt-deuxième est ``r``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°22 !`)
  } 
  
   if (message.content.toLocaleLowerCase() === `/case 23`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°23 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la vingt-troisième case de votre calendrier : Mon vingt-troisième est ``d``.")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°23 !`)
  } 
  
  
   if (message.content.toLocaleLowerCase() === `/case 24`) {		 
 if (message.channel.type == 'dm') return;
 if (message.channel.id !== '518190701050069012') return;
    message.delete()
    message.channel.send(`Tu viens d'ouvir la case n°24 de ton calendrier ! ${message.author}`)
    message.author.send("Voici le contenue de la vingt quatrième case de votre calendrier : Mon tout est une commande. Je te laisse également le privilège d'ouvrir toutes les anciennes cases aujourd'hui et seulement aujourd'hui !")
    client.channels.get('518188746219192320').send(`${message.author} à ouvert la case n°24 !`)
  } 
  
   if (message.content.startsWith("/8ball qNG3Dqg = discord")) {
	if (message.channel.type === "dm") return;
  if (message.channel.id !== '504394913979301888') return;
   message.delete()
  message.channel.send(`C'était pourtant facile !${message.author}`)
  message.author.send("https://discordapp.com/invite/qNG3Dqg")
   }
